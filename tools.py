...
def search_youtube(query):
    """
    Search YouTube for the given query in the default browser.
    """
...
def smart_youtube_search(query):
    """
    Open YouTube search results for a natural-language query.
    """
    ...
    try:
        ...
        # Give the browser a moment to load the results.
        time.sleep(2.0)
