...
# running slow local CPU vision/reasoning models.
# ============================================================
            ...
            messages=[
                {
                    ...
                    "content": (
                        "You are SPIDEY's screen analysis engine. "
                        "Be concise, factual, and use only the "
                        "provided evidence."
                    ),
                },
                {
...
def general_analysis():
    ...
    vision = get_visual(
        """Look at this computer screen and describe the
        important visible content and what the user appears
        to be doing.

        IMPORTANT:
        - Focus on the actual application/content area.
        - Ignore browser address bars and URLs.
        - Ignore browser tabs unless they are important.
        - Ignore status bars, system metadata and navigation
          text unless the user specifically asks about them.
        - Do not read or recite long URLs.
        - Do not invent anything that is not clearly visible.
    ...
    return (
        "I couldn't determine what is happening on the screen."
    )
...
def visual_question(question):
    ...
    vision = get_visual(
        f"""Answer this visual question about the computer
        screen:
        ...
        IMPORTANT:
        - Focus on the actual application/content area.
        - Ignore browser address bars and URLs unless the
          user specifically asks about them.
        - Ignore browser tabs and status-bar metadata unless
          relevant to the question.
        - Do not recite long URLs.
        - Only describe things clearly visible in the image.
    ...
    return "I couldn't determine the answer from the screen."
